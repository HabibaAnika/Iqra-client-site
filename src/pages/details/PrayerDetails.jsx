    ...
    <div className="relative py-24 bg-cover bg-center bg-[url('https://i.postimg.cc/85BQXjmH/quran.jpg')]">
      ...
      <div className="relative z-10 max-w-[80%] mx-auto">
        ...
        <p className="text-sm mb-4 bg-[#2beb754b] p-4 rounded-sm">
          {language === "en"
            ? "This course is conducted over 6 months, with 6 classes per week. Students will be taught in small batches of 5 to ensure personalized attention and guidance. The course fee is 999 per month."
            : "এই কোর্সটি ৬ মাস ধরে পরিচালিত হয়, সপ্তাহে ৫টি ক্লাস। শিক্ষার্থীদের ব্যক্তিগত মনোযোগ এবং দিকনির্দেশনা নিশ্চিত করতে ৫ জনের ছোট ব্যাচে পাঠ দেওয়া হয়। কোর্স ফি প্রতি মাসে ৯৯৯। "}
          <p>
            {language === "bn" ? (
              <>
                কোর্সের সময়সীমা: ৬ মাস মেয়াদী কোর্স
                <br />
                ক্লাসের সময়: সপ্তাহে ৫ দিন
                <br />
                কোর্স ফি ঃ ৯৯৯ টাকা (মাসিক) <br />
              ...
              <>
                Course Duration: 6 month course <br />
                Class Schedule: 5 days a week <br />
                Course Fee: 999 Taka (monthly) <br />
